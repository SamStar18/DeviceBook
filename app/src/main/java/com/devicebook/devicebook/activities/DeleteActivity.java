...
//add to database
        dbHelper = new MyDatabase(DeleteActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent menuintent = new Intent(DeleteActivity.this,DisplayGridActivity.class);
 ...
 if(entry.isEmpty()) {
            Toast.makeText(DeleteActivity.this, "Table doesnt exist ", Toast.LENGTH_SHORT).show();
            return false;
        }
            ...
            Toast.makeText(DeleteActivity.this, "Table Deleted ", Toast.LENGTH_SHORT).show();
            Intent returntodatabase = new Intent(DeleteActivity.this,DisplayGridActivity.class);
